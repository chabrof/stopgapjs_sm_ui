define(["require", "exports", "./tools"], function (require, exports, tools_1) {
    ...
    EltPrototype._approximateBezierTime = function (mousePos) {
        var mouseToLeftDotLength = tools_1.default.getDistanceBwDots(mousePos, this._dots[0]);
        var mouseToRightDotLength = tools_1.default.getDistanceBwDots(mousePos, this._dots[1]);
        return mouseToLeftDotLength / (mouseToLeftDotLength + mouseToRightDotLength);
    };
    EltPrototype.displayDotMoveIndics = function (dotIdx) {
        this._setVisibilityOfHandyDots(dotIdx, true);
        this._setVisibilityOfControlDot(false);
    };
    EltPrototype.hideDotMoveIndics = function (dotIdx) {
        if (!this._dotMoveActivated) {
            this._setVisibilityOfHandyDots(dotIdx, false);
        }
    };
    EltPrototype.displayCtrlMoveIndics = function () {
        this._setVisibilityOfControlDot(true);
        this._setVisibilityOfHandyDots(0, false);
        this._setVisibilityOfHandyDots(1, false);
    };
    EltPrototype.hideCtrlMoveIndics = function () {
    ...
    EltPrototype._stopCtrlMoving = function () {
    ...
    EltPrototype._startDotMoving = function (dotIdx) {
    ...
    EltPrototype._stopDotMoving = function (dotIdx) {
    ...
    EltPrototype._computePosWGrMap = function (dotIdx, potentialDot) {
        var newDot = this._gravitMovingDots[dotIdx].computePos(potentialDot);
        return newDot;
    };
    ...
    EltPrototype._repaint = function () {
        if (this._needsRepaint) {
            var data = "M " + this._dots[0].x + ',' + this._dots[0].y + " Q " + this._ctrlDot.x +
    ...
    EltPrototype._setVisibilityOfHandyDots = function (dotIdx, visible) {
    ...
    EltPrototype._setVisibilityOfControlDot = function (visible) {
        var opacity = visible ? '0.2' : '0.0';
...
//# sourceMappingURL=link_registration.js.map